  ...
  return {
    ...
    module: {
      rules: [
        ...
        // Rule for CSS modules
        {
          ...
          use: [
            "style-loader",
            {
              loader: "css-loader",
              options: {
                modules: true,  // CSS modules are enabled
              },
            },
            {
        ...
        // New rule for globals.css without CSS modules
        {
          test: /globals\.css$/,  // Specifically targeting globals.css
          use: [
            "style-loader",
            "css-loader",  // No modules option provided, defaults to false
            {
              loader: "postcss-loader",
              options: {
                postcssOptions: {
